...
class Ids(Resource):
    ...
    def __call__(self, interval: TimeInterval, page: Optional[int] = None, size: Optional[int] = None) -> CampaignData:
        ...
        return CampaignData(self.session.get(self.uri, params=options.params))
