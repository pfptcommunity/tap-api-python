...
if __name__ == '__main__':
    ...
    url_info_collection = client.url.decode([
    ...
    print("HTTP Status:", url_info_collection.get_status())
    print("HTTP Reason:", url_info_collection.get_reason())
    for url_info in url_info_collection:
